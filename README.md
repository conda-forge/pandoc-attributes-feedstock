About pandoc-attributes-feedstock
=================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pandoc-attributes-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5661&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pandoc-attributes-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pandoc-attributes` can be installed with `conda`:
...
```
mamba install pandoc-attributes
```

It is possible to list all of the versions of `pandoc-attributes` available on your platform with `conda`:
...
```
mamba search pandoc-attributes --channel conda-forge
```
...
mamba repoquery search pandoc-attributes --channel conda-forge

# List packages depending on `pandoc-attributes`:
mamba repoquery whoneeds pandoc-attributes --channel conda-forge

# List dependencies of `pandoc-attributes`:
mamba repoquery depends pandoc-attributes --channel conda-forge
```
